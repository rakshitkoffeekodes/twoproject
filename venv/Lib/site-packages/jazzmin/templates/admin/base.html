...
<head>
    ...
    <link rel="stylesheet" href="{% static "vendor/adminlte/css/new.css" %}" id="new-css">
    ...
    {% if not is_popup %}
        <nav class="main-header navbar navbar-expand {{ jazzmin_ui.navbar_classes }}" id="jazzy-navbar">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link btn" data-toggle="dropdown" href="#" title="{{ auth.user }}">
...
<!--                </a>-->
                ...
                <div class="sidebar">
                    <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                        ...
                        <div class="info">
                            {% if perms|can_view_self %}
                                <a class="admin-name" onmouseover="this.style.color='#E3FEF7'" onmouseout="this.style.color='#135D66'" href="{% jazzy_admin_url request.user request.current_app|default:"admin" %}" class="d-block">{{ request.user }}</a>
                            {% else %}
...
<!--                                <form action="{% url 'admin:logout' %}" method="post">-->
<!--                                    {% csrf_token %}-->
<!--                                    <button class="fas fa-sign-out-alt " id="btn-logout" type="submit">&ensp;&nbsp;Logout</button>-->
<!--                                </form>-->
<!--                            </li>-->
<!--                            <li class="nav-item">-->
<!--                                <a href="https://github.com/farridav/django-jazzmin/issues" class="nav-link" >-->
<!--                                    <i class="fas fa-circle mr-2"></i> Support-->
<!--                                </a>-->
<!--                            </li>-->
